...
export default function Home() {
  ...
  return (
    <div className="space-y-24 pb-24">
      {/* Hero Section */}
      <section className="relative mt-20 min-h-[60vh] lg:min-h-[800px] flex flex-col lg:items-center pt-20 lg:pt-0 overflow-hidden bg-white">
        ...
        <div className="order-3 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="order-2 flex flex-col justify-center px-6 py-10 text-left sm:px-10 lg:col-start-2 lg:h-[800px] lg:translate-x-[100px] lg:px-12 lg:items-center lg:text-center"
            >
